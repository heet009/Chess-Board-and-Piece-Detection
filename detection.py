...
def plot_grid_on_transformed_image(image):
    ...
    st.subheader("Transformed Image with Grid")
    st.image('chessboard_transformed_with_grid.jpg', caption='Transformed Image with Grid', use_column_width=True)
    return ptsT, ptsL
...
st.title("Chess Board and Piece Detection using YOLO")
uploaded_file = st.file_uploader("Choose an image...", type=["jpg", "png", "jpeg"])

if uploaded_file is not None:
    img = Image.open(uploaded_file)
    img = img.save(r"C:\Users\heetm\OneDrive\Desktop\DL Assignment\Code\uploaded_image.jpg")

    image_path = r"C:\Users\heetm\OneDrive\Desktop\DL Assignment\Code\uploaded_image.jpg"

    #image = r"C:\Users\heetm\OneDrive\Desktop\DL Assignment\Code\test.jpg"
    ...
    st.write(to_FEN)
    st.write(converted_fen)

    st.subheader("Board")

    #save the chessboard image and display it
    ...
    #show on the press of a button
    if st.button("Show Next Move"):
